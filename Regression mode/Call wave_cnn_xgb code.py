# -*- coding: utf-8 -*-
"""
Wave-CNN-XGB Model Prediction
Fixed version for Wave-CNN-XGB model prediction
"""
...
# 1. Define paths
MODEL_PATH = r"xxxx\wave_cnn_xgb.pkl"
OUTPUT_PATH = r"xxxx\pred_results.csv"
...
def predict_simple():
    try:
        ...
        # Prediction - this is a regression model, only has the predict method
        print("🎯 Making prediction...")
        predictions = model.predict(df_input)
        
        # Output results
        result_df = df_input.copy()
        result_df["pred_lr"] = predictions  # Regression prediction value
...
if __name__ == "__main__":
    print("=" * 50)
    print("Wave-CNN-XGB Model Prediction")
    print("=" * 50)
